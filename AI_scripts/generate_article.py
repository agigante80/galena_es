...
CSV_FILE_LIST_OF_AIERROR_TOPICS = "list_of_AIERROR_topics.csv"
    ...
    while True:
        ...
        try:
            ...
            with open(aierror_file_path, 'a') as aierror_file:
                ...
                writer.writerow([topic_idea, description])
            logging.info(f"✅ Topic '{topic_idea}' moved to AIERROR topics.")
            
            # Send a Telegram message about the error
            send_telegram_message(bot_token, chat_id, f"❌ Error occurred while processing topic '{topic_idea}'. Moved to AIERROR topics. Error: {e}")
